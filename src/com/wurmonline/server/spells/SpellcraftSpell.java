...
public enum SpellcraftSpell {
    ...
    SPARK("Spark","spark",(byte) 122),
    FIREORB("FireOrb","fireorb",(byte) 123),
    ARCANEBULLET("Arcane Bullet","Arcanebullet",(byte) 124),
    BALLOFLIGHT("Ball of Light","Balloflight",(byte) 125),
    IRONFLOOR("Iron Floor","IronFloor",(byte) 126),
    DISINTEGR8TE("Disintegr8te","Disintegr8te",(byte)-1),
    COMBUST("Combust", "Combust",(byte) 127),
    AGGRAVATE("Aggravate","Aggravate",(byte)-1),
    DEFORESTATION("Deforestation","deforestation",(byte) -1),
    HEALINGMIST("HealingMist","healingmist",(byte)-1),
    WILLOWWISP("WillowWisp","willowwisp",(byte)-1);
    // Base Properties
    String name;
    String propName;
    byte enchant;
