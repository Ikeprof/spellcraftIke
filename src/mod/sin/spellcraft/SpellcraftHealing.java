        ...
        for (int x = sx; x <= ex; ++x) {
            for (int y = sy; y <= ey; ++y) {
                ...
                for (Creature lCret : crets2) {
                    ...
                    ++damdealt;
                    if (lCret.addWoundOfType(performer, Wound.TYPE_INTERNAL, 1, false, 1.0f, false, power * 80.0 * (double)lCret.addSpellResistance((short) 448),0f,0f,false,true)) continue;
