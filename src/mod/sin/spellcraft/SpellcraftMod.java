...
implements WurmServerMod, Configurable, PreInitable, Initable, ServerPollListener, ServerStartedListener {
    ...
    public static float sparkEffectiveness = 0.5f;
    public static float titanforgedMultiplier = 0.5f;
    public static float deforestationMultiplier = 0.5f;
    public static float aggravateMultiplier = 0.5f;
		...
		new Runnable(){
			...
			public void run(){
				try{
                    ...
                    SpellcraftSpell.SPARK.setSpell(new Spark(SpellcraftSpell.SPARK));
                    SpellcraftSpell.ARCANEBULLET.setSpell(new Arcanebullet(SpellcraftSpell.ARCANEBULLET));
                    SpellcraftSpell.BALLOFLIGHT.setSpell(new Balloflight(SpellcraftSpell.BALLOFLIGHT));
                    SpellcraftSpell.FIREORB.setSpell(new FireOrb(SpellcraftSpell.FIREORB));
                    SpellcraftSpell.LABOURING_SPIRIT.setSpell(new LabouringSpirit(SpellcraftSpell.LABOURING_SPIRIT));
                    SpellcraftSpell.IRONFLOOR.setSpell(new IronFloor(SpellcraftSpell.IRONFLOOR));
                    SpellcraftSpell.DISINTEGR8TE.setSpell(new Disintegr8te(SpellcraftSpell.DISINTEGR8TE));
                    SpellcraftSpell.COMBUST.setSpell(new Combust(SpellcraftSpell.COMBUST));
                    SpellcraftSpell.HEALINGMIST.setSpell(new HealingMist(SpellcraftSpell.HEALINGMIST));
                    SpellcraftSpell.DEFORESTATION.setSpell(new Deforestation(SpellcraftSpell.DEFORESTATION));
                    SpellcraftSpell.WILLOWWISP.setSpell(new WillowWispSpell(SpellcraftSpell.WILLOWWISP));
                    SpellcraftSpell.AGGRAVATE.setSpell(new Aggravate(SpellcraftSpell.AGGRAVATE));
                    for(SpellcraftSpell spell : SpellcraftSpell.values()){
